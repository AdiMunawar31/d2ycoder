...
const Combobox = ({
  ...
  const labelCombobox = selectedFilters?.find(
    ...
    <>
      ...
      >
          ...
          >
            {children ? (
              ...
              labelCombobox && labelCombobox?.length > 0 ? (
                ...
                <span className="line-clamp-1 text-placeholder">
            ...
            {isSubText && subText ? (
              <div className="line-clamp-1 text-green-500">({subText})</div>
            ) : null}
            {!removeArrow
              ? !disabled && (
        ...
        <DropdownMenuContent className={"w-fit p-0"}>
          <Command
            className={cn(
              "relative flex max-h-[300px] w-[400px] max-w-[95vw] flex-col bg-n-8",
              contentClassName
            )}
          >
            {!restProps.withoutAutoComplete ? (
              restProps.search === undefined ? (
                ...
                <Input
                  ...
                  placeholder={restProps.placeholderSearch ?? `Search ...`}
                  startContent={
              ...
              >
                {multipleCheckbox ? (
                  ...
                  <CommandList className="max-h-full">
                    ...
                    {!restProps.withoutAutoComplete &&
                    restProps.search &&
                    !!restProps.onSelectCreate &&
                    !restProps.selectCreate ? (
                      <CommandItem
                        value={restProps.search}
                        onSelect={() => {
                          if (restProps.onSelectCreate)
                            restProps.onSelectCreate(restProps.search);
